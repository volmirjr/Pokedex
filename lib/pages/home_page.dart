...
class _HomePageState extends State<HomePage> {
  ...
  void _filterPokemon(String name) {
    setState(() {
      filteredPokemons = _controller.pokemons.where((element) => element.name.toLowerCase().contains(name.toLowerCase())).toList();
    });
  }
  ...
  _buildText() {
    return Text(kAppTitle, style: TextStyle(color: Colors.black, fontFamily: 'Pokemon'));
  }
}
